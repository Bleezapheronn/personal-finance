...
export const productionAuthenticatedCommittedWriteRoutes = [
  ...
  "/prototype/repositories/buckets/active-state/write/activate", "/prototype/repositories/buckets/active-state/write/deactivate",
  ...
  "/prototype/repositories/categories/active-state/write/activate", "/prototype/repositories/categories/active-state/write/deactivate",
  "/prototype/repositories/accounts/write/create", "/prototype/repositories/accounts/write/update",
  "/prototype/repositories/accounts/active-state/write/activate", "/prototype/repositories/accounts/active-state/write/deactivate",
